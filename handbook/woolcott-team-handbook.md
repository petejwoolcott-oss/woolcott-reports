...
Isabella is bonused on buyer showings and in-person buyer appointments she sets up. She has two options for how a buyer opportunity is offered out:

1. **Flat Fee:** A **$300 fee** applies per appointment met - split evenly, with **$150 paid by Woolcott** and **$150 paid by the Buyer Agent** who attends. The fee is only paid if the appointment actually takes place.

2. **15% ISA Fee:** Buyer deals may alternatively operate on a **15% bonus structure** paid to Isabella at closing. There is no upfront appointment fee under this option. This gives flexibility in how the opportunity is delivered - it can be a showing, an in-office consultation, a phone call, or any other format. The 15% is calculated on Isabella's share of the buy-side commission once the deal closes.

Distribution of buyer opportunities is at Isabella's discretion among Buyer Agents. Isabella determines which fee structure applies when the opportunity is offered. Standard buyer-side commission splits apply.
...
![FUB Lead Profile Overview](./images/image6.png)
...
![FUB Smart Lists Sidebar](./images/image1.png)
...
![FUB Add Person Form](./images/image3.png)
